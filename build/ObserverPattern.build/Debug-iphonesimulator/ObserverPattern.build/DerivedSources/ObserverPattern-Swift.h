...
#ifndef OBSERVERPATTERN_SWIFT_H
#define OBSERVERPATTERN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ObserverPattern",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15ObserverPattern11AppDelegate")
...
SWIFT_CLASS("_TtC15ObserverPattern13SceneDelegate")
...
SWIFT_CLASS("_TtC15ObserverPattern14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified subscriberInfoLabel;
- (void)viewDidLoad;
- (IBAction)publishButton:(id _Nonnull)sender;
- (IBAction)subscribeToggle:(id _Nonnull)sender;
